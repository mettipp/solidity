...
contract contracting{
    ...
    function pay(uint _ContractId) public payable returns(string memory){
        require (msg.sender==ContractIdentify[_ContractId].Employer);
        require (msg.value==ContractIdentify[_ContractId].CostOfProject);
        require (ContractIdentify[_ContractId].CurrentStatus == Status.notstarted);
